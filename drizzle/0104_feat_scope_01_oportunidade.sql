-- migration: 0104_feat_scope_01_oportunidade.sql
-- (nome SEM "cnae" — REGRA-ORQ-FILENAME-01 / Lição #81: o guard touchesRag casa
--  substring 'cnae' no filename; a tabela mantém o nome real no conteúdo. Lição #92.)
