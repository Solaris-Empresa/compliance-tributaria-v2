...
| Z-15 | fix L1107 (#598) + RAG badge (#600) + plans preview (#601) + AI suggestion (#602) + mockups HTML Z-15 (#599) + getActionPlanSuggestion procedure + PLANS export + 180_dias prazo | #599–#607 | **ENCERRADA** |
...
| Sprint Z-15 | **ENCERRADA** — 4 issues · RAG badge · plans preview · AI suggestion · fix L1107 | SPRINT-Z15-LOG.md |
