// Tabela CNAE 2.3 oficial IBGE — 1332 subclasses
// Fonte: https://servicodados.ibge.gov.br/api/v2/cnae/subclasses
// Gerado automaticamente em build_cnae_table.py
...
export const CNAE_TABLE: CnaeEntry[] = [
  {
    "code": "0111-3/01",
...
export function getCnaeByCode(code: string): CnaeEntry | undefined {
  ...
  return CNAE_TABLE.find(c => c.code.replace(/[^0-9]/g, "") === normalized);
}
